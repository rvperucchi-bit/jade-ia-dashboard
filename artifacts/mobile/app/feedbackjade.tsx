...
const S = StyleSheet.create({
  ...
  jadeBannerText: { flex: 1, fontSize: 15, fontFamily: "SpaceGrotesk_400Regular", lineHeight: 20 },
  ...
  segmento: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", marginTop: 2 },
  ...
  metaText: { fontSize: 15, fontFamily: "SpaceGrotesk_400Regular" },
  acimaCelebra: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold" },
  statusBanner: { borderRadius: 10, padding: 12 },
  statusText: { fontSize: 15, fontFamily: "SpaceGrotesk_500Medium", lineHeight: 19 },
  ...
  feedbackLabel: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold" },
  feedbackText: { fontSize: 16, fontFamily: "SpaceGrotesk_400Regular", lineHeight: 22, padding: 12, paddingTop: 4 },
  ...
  feedbackBtnText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold" },
});
