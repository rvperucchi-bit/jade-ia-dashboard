...
const S = StyleSheet.create({
  ...
  alertText: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold" },
  ...
  cardContato: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", marginTop: 3 },
  cardData: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", marginTop: 1 },
  diasBadge: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, alignItems: "center" },
  diasText: { fontSize: 16, fontFamily: "SpaceGrotesk_700Bold" },
  ...
  analiseLabel: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold" },
  analiseText: { fontSize: 16, fontFamily: "SpaceGrotesk_400Regular", lineHeight: 22, padding: 16 },
  ...
  modalSub: { fontSize: 15, fontFamily: "SpaceGrotesk_400Regular", marginTop: -4 },
  fieldLabel: { fontSize: 13, fontFamily: "SpaceGrotesk_500Medium", textTransform: "uppercase", letterSpacing: 0.5 },
