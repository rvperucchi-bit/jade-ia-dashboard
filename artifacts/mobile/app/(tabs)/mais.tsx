  ...
  const CATEGORIES: {
  ...
  }[] = [
    {
      ...
      items: [
        ...
        { label: "Carteira",   iconNode: <Feather name="briefcase"      size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/carteira"  as any); } },
        ...
        { label: "Metas",      iconNode: <Feather name="trending-up"    size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/metas"     as any); } },
      ],
    },
    {
      label: "INTELIGÊNCIA IA",
      items: [
        { label: "Marketing IA", iconNode: <Feather name="radio"       size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/marketing" as any); } },
        { label: "Análise IA",   iconNode: <Feather name="cpu"         size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/analise"   as any); } },
    ...
    },
    {
      label: "GESTÃO",
      items: [
        { label: "Meu Time",          iconNode: <Feather name="user-plus"    size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/meutime"         as any); } },
        { label: "Gest. Inteligente", iconNode: <Feather name="activity"     size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/gestao"          as any); } },
        { label: "Metas & KPIs",      iconNode: <Feather name="target"       size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/metas"           as any); } },
        { label: "Pipeline Equipe",   iconNode: <Feather name="grid"         size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/painelexecutivo" as any); } },
        { label: "Ranking",           iconNode: <Feather name="award"        size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/relatoriogestor" as any); } },
        { label: "Carteira Geral",    iconNode: <Feather name="briefcase"    size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/carteira"        as any); } },
        { label: "Feedback JADE",     iconNode: <Feather name="cpu"          size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/feedbackjade"    as any); } },
        { label: "Relat. Gestor",     iconNode: <Feather name="file-text"    size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/relatoriogestor" as any); } },
        { label: "Análise Estratégica", iconNode: <Feather name="bar-chart-2" size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/analise"        as any); } },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Objeções",     iconNode: <Feather name="shield"    size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/objecoes"     as any); } },
        { label: "Roleplay",     iconNode: <Feather name="users"     size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/roleplay"     as any); } },
        { label: "Criar Rota",   iconNode: <Feather name="map-pin"   size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/criarrota"    as any); } },
        { label: "Planejamento", iconNode: <Feather name="calendar"  size={20} color={pinkIc} />, locked: false, onPress: () => { tap(); router.push("/planejamento" as any); } },
