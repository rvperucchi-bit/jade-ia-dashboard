...
const S = StyleSheet.create({
  ...
  loadingText: { fontSize: 16, fontFamily: "SpaceGrotesk_400Regular", marginTop: 8 },
  ...
  confirmBadgeText: { fontSize: 13, fontFamily: "SpaceGrotesk_600SemiBold" },
  ...
  itemTitulo: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold", flex: 1 },
  itemHorario: { fontSize: 15, fontFamily: "SpaceGrotesk_700Bold" },
  itemDesc: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", lineHeight: 18, marginTop: 4 },
  ...
  editTextInput: { flex: 1, fontSize: 16, fontFamily: "SpaceGrotesk_400Regular" },
  editCancelBtn: { flex: 1, height: 42, borderRadius: 10, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  editCancelText: { fontSize: 16, fontFamily: "SpaceGrotesk_500Medium" },
  editSaveBtn: { flex: 1, height: 42, borderRadius: 10, alignItems: "center", justifyContent: "center" },
  editSaveText: { color: "#fff", fontSize: 16, fontFamily: "SpaceGrotesk_700Bold" },
  ...
  jadeBtnText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold" },
  ...
  confirmedSub: { fontSize: 13, fontFamily: "SpaceGrotesk_400Regular", marginTop: 3 },
});
