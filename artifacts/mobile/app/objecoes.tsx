...
const S = StyleSheet.create({
  ...
  labelSub: { fontSize: 12, fontFamily: "SpaceGrotesk_400Regular", marginTop: -4 },
  ...
  chipLabel: { fontSize: 13, fontFamily: "SpaceGrotesk_500Medium" },
