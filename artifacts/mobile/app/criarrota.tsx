...
const S = StyleSheet.create({
  ...
  infoText: { flex: 1, fontSize: 15, fontFamily: "SpaceGrotesk_400Regular", lineHeight: 20 },
  ...
  paradaNumText: { fontSize: 13, fontFamily: "SpaceGrotesk_700Bold" },
  paradaTitle: { flex: 1, fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold" },
  ...
  switchLabel: { fontSize: 15, fontFamily: "SpaceGrotesk_600SemiBold" },
  ...
  mapsBtnText: { fontSize: 16, fontFamily: "SpaceGrotesk_600SemiBold" },
