  ...
  return (
    <View style={[S.root, { backgroundColor: colors.background }]}>
      ...
      <View style={[S.header, { paddingTop: topPad }]}>
        ...
        <Text style={[S.headerTitle, { color: colors.text }]}>Termos de Uso</Text>
        <View style={{ width: 36 }} />
      </View>
      ...
      >
        <View style={S.hero}>
          <View style={[S.heroIcon, { backgroundColor: PINK + "18" }]}>
            <Feather name="file-text" size={28} color={PINK} />
          </View>
          <Text style={[S.heroTitle, { color: colors.text }]}>Termos de Uso</Text>
